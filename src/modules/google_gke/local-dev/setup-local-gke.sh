...
echo "  4. Auth mode: Auto-detect → Test Connection → Save"
echo "  5. Go to Settings → Data Management → Load Default Data"
echo "  6. Enable the Poller in Settings → Poller Configuration"
echo "  7. View the Dashboard — all components should appear!"
echo "═══════════════════════════════════════════════════════════════════════"
