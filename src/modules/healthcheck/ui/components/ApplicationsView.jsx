// ============================================================================
// ApplicationsView — HealthCheck Module Applications Management
//
// PURPOSE: Full CRUD management for monitored applications — add, edit, delete,
//          toggle active. Modal popup form for Add/Edit with confirmation.
//          Persistent success messages. ConfirmDialog for delete.
//
// USED BY: manifest.jsx → getViews() → sidebar navigation (applications)
// ============================================================================
...
const log = createLogger('ApplicationsView.jsx');
